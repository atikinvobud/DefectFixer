...
public class UserValidator : AbstractValidator<RegistrDTO>
{
    public UserValidator()
    {
        ...
        RuleFor(dto => dto.Patronymic)
            ...
            .Length(5, 30).WithMessage("Отчество должно быть от 5 до 30 символов")
            .Matches(@"^[А-Я][а-я]+$").WithMessage("Отчество должно быть русскими буквами, причем первая заглавная");
    }
}